...
persp(y,x,z,theta=90,phi=0,expand=1,col="blue",xlab = " ", ylab = " ", zlab = " ")
par(new=TRUE)
persp(y,x,v,theta=90,phi=0,expand=1,col="red",xlab = "¦È", ylab = "¦Â", zlab = "¦Ð", ticktype = "detailed")
